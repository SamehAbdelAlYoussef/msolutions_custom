...
{   'name': 'Invoicing',
    ...
    'icon': '/account_accountant/static/description/icon.png',
    'description': '\n'
                   'Invoicing Access Rights\n'
                   '========================\n'
                   'It gives the Administrator user access to important invoicing features such as bank '
                   'recon and payment follow-up.\n'
                   '\n',
    ...
    'author': 'msolutions',
    'license': 'OPL-1',
    'assets': {   'web.assets_backend': [   'account_accountant/static/src/js/tours/account_accountant.js',
                                            'account_accountant/static/src/components/**/*',
                                            'account_accountant/static/src/**/*.xml'],
                  'web.assets_unit_tests': [   'account_accountant/static/tests/**/*',
                                               ('remove', 'account_accountant/static/tests/tours/**/*')],
                  'web.assets_tests': ['account_accountant/static/tests/tours/**/*']}}
