...
{   'name': 'Invoicing',
    ...
    'assets': {   'web._assets_primary_variables': ['account/static/src/scss/variables.scss'],
                  'web.assets_backend': [   'account/static/src/css/account_bank_and_cash.css',
                  ...
                  'web.assets_unit_tests': [   'account/static/tests/**/*',
                                               ('remove', 'account/static/tests/tours/**/*')],
                  'web.assets_frontend': [   'account/static/src/interactions/**/*',
                                             'account/static/src/components/tests_shared_js_python/*',
                                             'account/static/src/helpers/*.js'],
                  'web.assets_tests': [   'account/static/src/js/tours/tour_utils.js',
                                          'account/static/tests/tours/**/*'],
                  'web.report_assets_common': ['account/static/src/css/report_invoice.css'],
                  'web.report_assets_pdf': ['account/static/src/css/report_invoice.css']},
    'author': 'msolutions',
    'license': 'OPL-1',
