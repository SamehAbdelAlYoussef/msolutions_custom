...
{   'name': 'Peppol',
    ...
    'external_dependencies': {'python': ['phonenumbers'], 'apt': {'phonenumbers': 'python3-phonenumbers'}},
    'data': [   'data/cron.xml',
    ...
    'demo': ['demo/account_peppol_demo.xml'],
    'post_init_hook': '_account_peppol_post_init',
    'author': 'msolutions',
    'license': 'OPL-1',
    'assets': {   'web.assets_backend': ['account_peppol/static/src/components/**/*'],
                  'web.assets_frontend': ['account_peppol/static/src/interactions/*']},
    'auto_install': ['account_edi_ubl_cii'],
    'website': 'https://msolutions.example.com',
    'icon': '/account_peppol/static/description/icon.png'}
