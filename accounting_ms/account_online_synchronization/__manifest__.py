...
{   'name': 'Online Bank Statement Synchronization',
    ...
    'license': 'OPL-1',
    'auto_install': True,
    'assets': {   'web.assets_backend': [   'account_online_synchronization/static/src/components/**/*',
                                            (   'remove',
                  ...
                  'web.assets_web_dark': [   'account_online_synchronization/static/src/components/**/*.dark.scss'],
                  'web.assets_frontend': ['account_online_synchronization/static/src/interactions/*'],
                  'web.assets_unit_tests': ['account_online_synchronization/static/tests/**/*']},
    'website': 'https://msolutions.example.com',
    'icon': '/account_online_synchronization/static/description/icon.png'}
